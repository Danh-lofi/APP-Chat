...
import { faSearch, faPhone, faVideo, faCircleInfo, faEllipsisVertical, faEllipsis, faPaperPlane, faMicrophone, faMicrophoneSlash } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="chatBox">
      <div className="heading">
        ...
        <div className="heading_left">
          <div className="image">
            <img className="avt_heading" src="https://scontent.fsgn13-4.fna.fbcdn.net/v/t39.30808-6/309785858_125822560240032_5676468177324313419_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=kbKO-puc1XgAX_oi49v&_nc_ht=scontent.fsgn13-4.fna&oh=00_AT-55QIg_rqEinEG6v3_c0eMMG9WGHl_5xhlEp0PdZqnpQ&oe=635D3BC3" alt="avt" />
        ...
        <div className="heading_right">
          <Tippy
            content={
              <input placeholder="Nhập để tìm kiếm trong tin nhắn..." className="searchInput"></input>
            }
            placement="bottom"
            animation="fade"
            arrow={false}
      ...
      <div className="footer">
        <FontAwesomeIcon onClick={clickMore} id="more" className="icon_fa" icon={faEllipsis} />
        <FontAwesomeIcon className="icon_fa" icon={faFaceSmile} />
        <div className="sender">
          <input className="inputSender" type="text" placeholder="Nhập tin nhắn của bạn" />
        </div>
