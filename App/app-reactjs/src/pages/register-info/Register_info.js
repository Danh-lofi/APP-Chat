    ...
    <div className="login">
      <div className="login__container">
        <div className="login__title">
          ...
          <p className="login__title__sub">Cập nhật tài khoản SUARCHAT miễn phí của bạn ngay bây giờ.</p>
        </div>
        <div className="login__input">
          ...
          <select className="input-authen__input" onChange={(option) => setGender(option.target.value)}  name="gender">
